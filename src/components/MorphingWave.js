...
export default function MorphingWave() {
    ...
    return (_jsx(motion.svg, { viewBox: "0 0 500 150", preserveAspectRatio: "none", style: { height: '60px', width: '100%' }, children: _jsx(motion.path, { d: wavePaths[0], animate: { d: wavePaths }, transition: { duration: 8, repeat: Infinity, ease: "easeInOut" }, style: { fill: '#16f09822', stroke: 'none' } }) }));
}
